...
from .models import Guest_ProfilePermission,Categories,Instructor,Levels,Language,Course,Lesson,CourseResource,What_u_learn,Requirements,VideoModels,Quiz,Question,Guest
    ...
    def decorator(view_func):
        ...
        def _wrapped_view(request, *args, **kwargs):
            if hasattr(request.user, 'Guest'):
                ...
                permission = Guest_ProfilePermission.objects.filter(guest=guest).first()
